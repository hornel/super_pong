...
public class SinglePlayerTrainingPongCanvas extends PongCanvas {
     ...
     */
    private double wallYRatio = 0.125;
    ...
    protected void addListeners() {
        ...
        addComponentListener(new ComponentAdapter() {
            ...
            public void componentResized(ComponentEvent e) {
                ...
                wall.setPaddleY(e.getComponent().getHeight() * wallYRatio);
    ...
    /**
     * Change le rapport entre la coordonee x du mur et la hauteur du jeu.
     */
    public void setWallYRatio(double wallYRatio) {
        this.wallYRatio = wallYRatio;
    }
}