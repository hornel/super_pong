    ...
    protected void addListeners() {
        ...
        addComponentListener(new ComponentAdapter() {
            ...
            public void componentResized(ComponentEvent e) {
                ...
                // Si la raquette est plus grande que la fenetre, il faut changer sa taille.
                if (playerPaddle.getHeight() > getHeight() - 2 * PongPreferencesEditor.PADDING) {
                    playerPaddle.setPaddleHeight(getHeight() - 2 * PongPreferencesEditor.PADDING);
                    playerPaddle.setPaddleY(PongPreferencesEditor.PADDING);
                }
                repaint();
            }
            ...
            addPaddleCollisionDetector(new PongPaddleCollisionDetector(this, paddle) {
                ...
                public void performCustomAction() {
                    ...
                    if (!paddle.getPaddleMode().equals(PaddleMode.HUMAN)) {
                        ...
                        // On prepare la brique a etre detruite definitivement (c'est-a-dire enlevee de la liste des
