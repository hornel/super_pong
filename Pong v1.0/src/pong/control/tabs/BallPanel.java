...
public class BallPanel extends PongTabPanel {
    ...
    private void init() {
        ...
        // On veut que les chiffres sur le slider de la vitesse apparaissent dans l'ordre suivant: 1, 5, 10, 15, 20, 25
        Hashtable<Integer, JLabel> labelTable = new Hashtable<Integer, JLabel>();
        labelTable.put(1, new JLabel("1"));
        for (int i = 5; i <= PongPreferencesEditor.MAXIMUM_BALL_SPEED * 10; i += 5) {
            labelTable.put(i, new JLabel(Integer.toString(i)));
        }
        ballSpeedSlider.setLabelTable(labelTable);
