...
public class PongPreferencesEditor {
    ...
    public void setPaddleHeight(double height) {
        ...
        for (Paddle paddle : paddles) {
            ...
            if (paddle.getPaddleMode().equals(PaddleMode.HUMAN) || paddle.getPaddleMode().equals(PaddleMode.AI) || paddle.getPaddleMode().equals(PaddleMode.BATTLE_AI)) {
    ...
    public void setWallPosition(double position) {
        ...
        if (pongCanvas instanceof SinglePlayerTrainingPongCanvas) {
            ...
            trainingPongCanvas.setWallYRatio(position / trainingPongCanvas.getHeight());
            pongCanvas.repaint();
        }
    }
    ...
    public void toggleScoreEnabled() {
        ...
        if (pongCanvas instanceof TwoPlayerPongCanvas) {
            ...
            // Le score minimal doit etre superieur au score des joueurs.
    ...
    public void setAiDifficulty(int aiDifficulty) {
        ...
        if (pongCanvas instanceof AIPongCanvas) {
            ...
            AIPongCanvas aiPongCanvas = (AIPongCanvas) pongCanvas;
