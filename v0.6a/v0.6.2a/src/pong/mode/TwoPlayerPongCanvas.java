...
public abstract class TwoPlayerPongCanvas extends PongCanvas {
    ...
    void drawCanvas(Graphics g) {
        ...
        if (scoreEnabled && player1Score == maxScore) {
            winnerString = String.format(winnerString, lang.get("left"));
            ...
            int xstart = getWidth() / 2 - stringWidth / 2;                                                  // center the string horizontally
            ...
            winnerString = String.format(winnerString, lang.get("right"));
