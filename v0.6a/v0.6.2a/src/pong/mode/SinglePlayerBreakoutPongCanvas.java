...
public class SinglePlayerBreakoutPongCanvas extends PongCanvas {
    ...
    void drawCanvas(Graphics g) {
        ...
        if (gameOver) {
            g2d.setFont(new Font(scoreFont, Font.PLAIN, 75));
    ...
    void addListeners() {
        ...
        addMouseMotionListener(new MouseMotionAdapter() {
            ...
            public void mouseMoved(MouseEvent e) {
                ...
                if (!isPaused() && e.getY() <= getHeight() - PongPreferencesEditor.PADDING - playerPaddle.getHeight() / 2 && e.getY() > PongPreferencesEditor.PADDING + playerPaddle.getHeight() / 2) {
