...
class PongCanvas extends JPanel {
    ...
    private static final int INITIAL_PADDLE_WIDTH = 20;
    private static final int INITIAL_PADDLE_HEIGHT = 100;
    private static final int INITIAL_PADDLE1_X = 10;
    private final int INITIAL_PADDLE2_X = panelWidth - INITIAL_PADDLE_WIDTH - 10;
    private final int INITIAL_PADDLE1_Y = panelHeight / 2 - INITIAL_PADDLE_HEIGHT / 2;
    private final int INITIAL_PADDLE2_Y = INITIAL_PADDLE1_Y;

    private Ball ball;
    private static final int INITIAL_BALL_X = 50;
    private static final int INITIAL_BALL_Y = 50;
    private static final int INITIAL_BALL_DIAMETER = 20;
    static final int INITIAL_X_TRAJECTORY = 9;
    private static final int INITIAL_Y_TRAJECTORY = 9;
...
//    }
    ...
    Thread getAnimationThread() { return animationThread; }
