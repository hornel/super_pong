...
import pong.mode.TwoAIAndHumanPlayerPongCanvas;
...
public class AIPanel extends PongTabPanel {
     ...
     */
    private TwoAIAndHumanPlayerPongCanvas pongCanvas;
    ...
    public AIPanel(PongCanvas pongCanvas) {
        ...
        if (pongCanvas instanceof TwoAIAndHumanPlayerPongCanvas) {
            this.pongCanvas = (TwoAIAndHumanPlayerPongCanvas) pongCanvas;
        }
