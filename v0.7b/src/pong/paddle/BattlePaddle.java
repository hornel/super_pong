...
public class BattlePaddle extends Paddle {
    ...
    /**
     * Valeur decrivant la hauteur de la raquette avant qu'elle etait detruite.
     */
    ...
    public void destroy() {
        ...
        setMoveable(false);
        // on enregistre la position et la hauteur de la raquette.
        oldPaddleHeight = getPaddleHeight();
        oldPaddleOffset = getSide() == LEFT ? getX() : battlePongCanvas.getWidth() - getX();
        // on change la hauteur de raquette a -1 pour qu'elle ne soit plus la physiquement
        setPaddleHeight(-1);
