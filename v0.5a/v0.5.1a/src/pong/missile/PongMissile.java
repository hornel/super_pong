...
public class PongMissile extends Rectangle2D.Double {
    ...
    public void move() {
        ...
        missileX += trajectory;
        super.setRect(missileX, missileY, width, height);
    }
    ...
    public void reset() {
        ...
        super.setRect(missileX, parentPaddle.getYCenter(), width, height);
    }
