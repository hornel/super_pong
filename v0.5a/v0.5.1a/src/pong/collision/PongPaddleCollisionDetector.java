...
public class PongPaddleCollisionDetector {
    ...
    public void checkCollisions() {
        ...
        if ((ballHitPaddleOuterEdge() && ballNotBehindPaddle()) && ballDidNotSurpassPaddleUpperEdge() && ballDidNotSurpassPaddleLowerEdge()) {
